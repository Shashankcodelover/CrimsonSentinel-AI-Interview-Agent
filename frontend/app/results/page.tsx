  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-on-background">
      ...
      <main className="mx-auto flex w-full max-w-container-max flex-1 flex-col gap-12 px-margin-mobile py-16 md:px-margin-desktop md:py-20 print:gap-8 print:py-8">
        ...
        <div className="rounded border border-warning/50 bg-warning/10 p-4 font-body text-body-md text-warning print:hidden">
          <strong>Note:</strong> This evaluation was generated by the local frontend mock engine using regex heuristics. It is designed to demonstrate the UI layout and features. For accurate, context-aware AI evaluations, the backend API must be wired up by the backend team.
        </div>
