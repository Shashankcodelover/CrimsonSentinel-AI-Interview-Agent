  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-on-background">
      ...
      <main className="mx-auto flex w-full max-w-container-max flex-1 flex-col gap-12 px-margin-mobile py-16 md:px-margin-desktop md:py-20 print:gap-8 print:py-8">
        ...
        <div className="rounded border border-primary-container/40 bg-surface-container/60 p-4 font-body text-body-md text-on-surface-variant print:hidden flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <span className="flex size-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>
              <strong className="text-on-surface">Verified by Sentinel Cognitive Evaluator:</strong> Multi-dimensional rubric calibrated to L6/Staff Engineer baseline across 4 core architectural quadrants.
            </span>
          </div>
          <span className="shrink-0 rounded border border-secondary-container px-2.5 py-1 font-code text-code-sm text-brand">
            Rubric v2.4 Active
          </span>
        </div>
