...
- Interview: timer, end confirm, word count, autofocus, Probe Depth, **Probe Cadence**, Memory Rail (preview), Live Draft, Ghost Next Probe, Role Calibration, signal-term highlighting, soft time arc, low-signal banner.
